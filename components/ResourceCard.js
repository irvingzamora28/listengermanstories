...
export default function ResourceCard({ title, url, image, description }) {
  return (
    <a href={url} target="_blank" rel="noopener noreferrer" className="my-4 block max-w-md rounded-lg border border-gray-200 bg-white p-4 shadow transition-shadow hover:shadow-lg dark:border-gray-700 dark:bg-gray-900">
