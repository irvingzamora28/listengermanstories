...
inquirer
  ...
  .then((answers) => {
    ...
    if (!fs.existsSync('data/stories')) fs.mkdirSync('data/stories', { recursive: true })
    const filePath = `data/stories/${fileName ? fileName : 'untitled'}.${answers.extension ? answers.extension : 'md'}`
